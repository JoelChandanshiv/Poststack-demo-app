...
module "networking" {
  ...
  # Dev: one shared NAT Gateway is enough - no HA requirement, keeps cost down.
...
module "secrets" {
  ...
  # Dev secrets can be deleted immediately if recreated; nothing depends on
  # recovering an old dev secret.
